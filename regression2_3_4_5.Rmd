---
title: "Regression 2, Regression 3, Regression 4, Regression 5 "
author: "Nam Tran"
date: "2022-08-08"
output: word_document
---

The project is demonstrate the correlation between <market return, sector return, adjusted market return and adjusted sector return> and the stock individual returns. Insights from this developing model could be used to build arbitrage pricing models, hedging strategies, etc.

- Stocks are selected from the S&P 500, with full historical data during the period of 2016-2021. 

- Stock data are obtained from CRSP, Wharton Research Data Services.
...
-  Regression with Sector premium as explanatory variables only
...
- In this model, we take into account the effect of adjusted return of sector premium and market premium. 
- Adjusted sector premium is the return of sector excluding the return of the individual stock. Adj market premium is the return of market excluding the return of the given sector. 
